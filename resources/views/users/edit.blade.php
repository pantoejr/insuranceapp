                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" value="{{ old('name', $user->name) }}" placeholder="Enter name"
                                        required @error('name') aria-describedby="name-error" @enderror name="name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        id="phone" value="{{ old('phone', $user->phone) }}" placeholder="Enter phone"
                                        name="phone">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" value="{{ old('email', $user->email) }}" placeholder="Enter email"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <small class="form-text text-danger">Leave blank to keep current password</small>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
