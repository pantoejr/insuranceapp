                    ...
                    <form action="{{ route('policies.update', $policy->id) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', $policy->name) }}" required>
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('number') is-invalid @enderror" id="number"
                                name="number" value="{{ old('number', $policy->number) }}" required>
                            @error('number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('policy_duration') is-invalid @enderror"
                                id="policy_duration" name="policy_duration"
                                value="{{ old('policy_duration', $policy->policy_duration) }}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" id="status" name="status"
                                ...
                                <option value="inactive"
                                    {{ old('status', $policy->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
