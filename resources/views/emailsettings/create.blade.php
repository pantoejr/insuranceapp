                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('driver') is-invalid @enderror"
                                        id="driver" value="{{ old('driver') }}" placeholder="Enter driver" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('host') is-invalid @enderror"
                                        id="host" value="{{ old('host') }}" placeholder="Enter host" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('port') is-invalid @enderror"
                                        id="port" value="{{ old('port') }}" placeholder="Enter port" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror"
                                        id="username" value="{{ old('username') }}" placeholder="Enter username" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"
                                        id="password" value="{{ old('password') }}" placeholder="Enter password" required
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('encryption') is-invalid @enderror"
                                        id="encryption" value="{{ old('encryption') }}" placeholder="Enter encryption"
                                        required @error('encryption') aria-describedby="encryption-error" @enderror
                                        name="encryption">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" class="form-control @error('from_address') is-invalid @enderror"
                                        id="from_address" value="{{ old('from_address') }}" placeholder="Enter from address"
                                        required @error('from_address') aria-describedby="from_address-error" @enderror
                                        name="from_address">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('from_name') is-invalid @enderror"
                                        id="from_name" value="{{ old('from_name') }}" placeholder="Enter from name" required
